...
<xsl:sort/>
    <xsl:value-of select="author"/><xsl:text>	</xsl:text> <xsl:value-of select="title"/><xsl:text>	</xsl:text><xsl:value-of select="//bibl[@type='originalSource']/date[@type='written']/@when"/>
